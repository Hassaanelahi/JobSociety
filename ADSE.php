            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="main-header">
                        <h4><i class="icon-graduation text-dark"></i> ADSE</h4>
                    </div>
                </div>
                ...
                <div class="row dashboard-header">
                    ...
                    <?php
                    $query2 = "SELECT * FROM jobs WHERE semester = 'ADSE' ORDER BY id DESC";
                    ...
                    if ($total != 0) {
                        ...
                        while ($result = mysqli_fetch_assoc($data)) {
                            ...
                            <a class='edit_user' href='job_details.php?id=$result[id]&j_t=" . urlencode($result['job_title']) . "&c_n=" . urlencode($result['company_name']) . "&se=" . urlencode($result['semester']) . "&ce=" . urlencode($result['company_email']) . "&
                                ...
                                be=" . urlencode($result['benefits']) . "&req=" . urlencode($result['requirements']) . "&adseactive=". $active ."'>
