            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="main-header">
                        <h4><i class="icon-badge text-dark"></i> DISM</h4>
                    </div>
                </div>
                ...
                <div class="row dashboard-header">
                    ...
                    <?php
                    $query2 = "SELECT * FROM jobs WHERE semester = 'DISM' ORDER BY id DESC";
                    ...
                    if ($total != 0) {
                        ...
                        while ($result = mysqli_fetch_assoc($data)) {
                            ...
                            <div class='col-lg-4 col-md-6'>
                                ...
                                be=" . urlencode($result['benefits']) . "&req=" . urlencode($result['requirements']) . "&dismactive=". $active ."'>
