...
if (isset($_POST['Delete'])) {
    ...
    $query3 = "DELETE FROM admin WHERE email='$em'";
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="main-header">
                        <h4><i class="icon-people"></i> Admins</h4>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-header-text">ALL ADMINS</h5>
                            </div>
                                                    ...
                                                    while ($result = mysqli_fetch_assoc($data)) {
                                                        ...
                                                        echo "
                                                            <tr>
                                                                <td>" . $rest . "</td>
                                                                <td>" . $result['email'] . "</td>
                                                                <td>" . mb_strimwidth(md5($result['password']), 0, 12, "...") . "</td>
                                                                <td> 
                                                                    <form method='POST'>
                                                                        <button type='submit' name='Delete' value='" . $result['email'] . "' class='edit_user'>Delete</button>
                                                                    </form>
                                                                </td>
                                                            </tr>";
                                                    }
