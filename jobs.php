            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="main-header">
                        <h4><i class="icon-briefcase text-dark"></i> Jobs</h4>
                    </div>
                </div>
                                                    ...
                                                    while ($result = mysqli_fetch_assoc($data)) {
                                                        echo "
                                                            <tr>
                                                                ...
                                                                <td> 
                                                                <a class='edit_user' href='update_job.php?id=$result[id]&j_t=" . urlencode($result['job_title']) . "&c_n=" . urlencode($result['company_name']) . "&se=" . urlencode($result['semester']) . "&ce=" . urlencode($result['company_email']) . "&
